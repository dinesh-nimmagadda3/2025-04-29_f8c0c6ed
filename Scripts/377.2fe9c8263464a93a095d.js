            ...
            return function (e, t) {
              var n,
                ...
                F = function (e) {
                  if (v) return !0;
                  (e = e || window.event),
                    w.timeToIdle && w.mouseUsed && !c && y();
                  for (
                    var n, o, l = (e.target || e.srcElement).className, r = 0;
                    r < U.length;
                    r++
                  )
                    (n = U[r]).onTap &&
                ...
                x = function () {
                  return (
                    !e.likelyTouchDevice || w.mouseUsed || screen.width > 1200
                  );
                },
                k = function (e, n, o) {
                ...
                M = 0,
                y = function () {
                  clearTimeout(b), (M = 0), c && _.setIdle(!1);
                },
                D = function (e) {
                ...
                t.extend(e.options, E, !0),
                  ...
                  (function () {
                    ...
                    p("onVerticalDrag", function (e) {
                      C && 0.95 > e
                        ? _.hideControls()
                        : !C && e >= 0.95 && _.showControls();
                    }),
                      p("onPinchClose", function (t) {
                        C && 0.9 > t
                          ? (_.hideControls(), (e = !0))
                          : e && !C && t > 0.9 && _.showControls();
                      }),
                      p("zoomGestureEnded", function () {
                        (e = !1) && !C && _.showControls();
                      });
                  })(),
                  ...
                  if (!v)
                    if (n.detail && "mouse" === n.detail.pointerType) {
                      ...
                      (w.tapToToggleControls &&
                        (C ? _.hideControls() : _.showControls()),
